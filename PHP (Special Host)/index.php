...
<head>
    ...
    <title>internet hotspot</title>
    <meta name="description" content="internet hotspot" />
    <style>
        .card-header {
...
<body>
    <div class="form-signin">
        <div class="text-center mb-2">
            <img class="mb-2" src="Infrastructure/img/globe.svg" alt="" width="100" height="100"> </img>
        </div>
        <br>
